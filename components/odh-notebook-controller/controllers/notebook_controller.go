...
func (r *OpenshiftNotebookReconciler) SetupWithManager(mgr ctrl.Manager) error {
	builder := ctrl.NewControllerManagedBy(mgr).
		...
		// TODO - this adds a hard dependency on the DSPA CR. We should consider what to do with it - maybe add it only in case the lookup for the DSPA CR is successful?
